...
namespace FunGamesSdk.FunGames.Ads.Crosspromo.Scripts
{
    public class CrosspromoRemoteController : MonoBehaviour
    {
        ...
        private UnityEngine.UI.Button _videoButton;
        ...
        private void Awake()
        {
            ...
            _videoButton = transform.Find("Root/Video").GetComponent<UnityEngine.UI.Button>();
            _playButton = transform.Find("Root/PlayButton").GetComponent<UnityEngine.UI.Button>();
